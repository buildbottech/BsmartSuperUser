...
const TechnicianTable = () => {
	...
	function ListView() {
		...
		const columns = [
			...
			{
				title: "Watch Manfacturer",
				dataIndex: "smartwatch",
				key: "watch",
				align: "left",
			},
			{ title: "Model", dataIndex: "model", key: "model", align: "left" },
			{ title: "Version", dataIndex: "version", key: "version", align: "left" },
			{
				title: "Location",
				dataIndex: "location",
				key: "location",
	...
	return (
		<div className="tech-discover-bg">
			<div className="tech-head-cont">
				{grid_view ? (
					<h3 className="tech-discover-head">Discovered</h3>
				) : (
					<div></div>
				)}
				<ToggleButton />
